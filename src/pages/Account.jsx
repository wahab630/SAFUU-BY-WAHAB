        ...
        <div className="row">
          ...
          <div className="card text-center mt-4 other-card">
              <div className="card-body">
                <h5 className="text-white  fw-bold">Your Balance</h5>
                <h5 className="center-t  fw-bold">$0</h5>
                <h5 className="text-white  fw-bold">0 SAFUU</h5>
              </div>
            </div>
          </div>
          <div className="col-lg-4">
          <div className="card text-center mt-4 other-card">
              <div className="card-body">
                <h5 className="text-white  fw-bold">APY</h5>
                <h5 className="center-t  fw-bold">383,025.8%</h5>
                <h5 className="text-white  fw-bold">Daily ROI 2.28%</h5>
              </div>
            </div>
          </div>
          <div className="col-lg-4">
          <div className="card text-center mt-4 other-card">
              <div className="card-body">
                <h5 className="text-white fw-bold">Next Rebase:</h5>
                <h5 className="center-t  fw-bold">00:07:28</h5>
                <h5 className="text-white  fw-bold">Rebasing...</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card  other-card px-3">
              <div className="card-body">
               <div className='account-card-first-item  '>
                ...
                <h5 className="text-white account-h fw-bold">$1.54</h5>
               </div>
               <div className='account-card-first-item mt-2 '>
                <p className='text-white account-p'>Next Reward Amount</p>
                <h5 className="text-white account-h  fw-bolder">0 SAFUU</h5>
               </div>
               <div className='account-card-first-item mt-2 '>
                <p className='text-white account-p'>Next Reward Amount USD</p>
                <h5 className="text-white account-h  fw-bolder">$0</h5>
               </div>
               <div className='account-card-first-item mt-2 '>
                <p className='text-white account-p'>Next Reward Yield</p>
                <h5 className="text-white account-h  fw-bolder">0.02355%</h5>
               </div>
               <div className='account-card-first-item mt-2 '>
               ...
               <div className='account-card-first-item mt-2 '>
                ...
                <h5 className="text-white account-h  fw-bolder">11.96%</h5>
               </div>
               <div className='account-card-first-item mt-2 '>
